        ...
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Subir el Excel</h4>
                            <form action="{{route('produccion.composicion.downloadexcel')}}" method="get" style="display: inline-block;">
            ...
            <div class="modal-body">
                ...
                <div id="imprimir" name="imprimir" style="display: none" >
                    <form action="{{route('produccion.composicion.error_excel')}}" method="get" >
                        @csrf
...
<script>
    var url="{{route('produccion.composicion.uploadexcel')}}";
