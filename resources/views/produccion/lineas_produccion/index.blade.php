...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
       <h2  style="text-transform:uppercase"><b>Listado de Lineas de Producción</b></h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('home')}}">Panel de Control</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Lineas de Producción</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2 col-md-2">
        <a class="btn btn-block btn-w-m btn-primary m-t-md" href="{{route('produccion.linea_produccion.create')}}">
            ...
            <div class="ibox ">
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table dataTables-linea_produccion table-striped table-bordered table-hover"
                        style="text-transform:uppercase">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Flujo Proceso (word)</th>
...
$(document).ready(function() {
    ...
    // DataTables
    $('.dataTables-linea_produccion').DataTable({
        ...
        "columns": [
            ...
            { data: 'archivo_word',className: "text-center"},
...

            {
                ...
                render: function(data) {
                    //Ruta Detalle
                    var url_detalle = '{{ route("produccion.linea_produccion.show", ":id")}}';
                    url_detalle = url_detalle.replace(':id', data.id);

                    //Ruta Modificar
                    var url_editar = '{{ route("produccion.linea_produccion.edit", ":id")}}';
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            //Ruta Eliminar
            var url_eliminar = '{{ route("produccion.linea_produccion.destroy", ":id")}}';
