...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-12">
       <h2  style="text-transform:uppercase"><b>REGISTRAR NUEVA LINEA DE PRODUCCION</b></h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{route('produccion.linea_produccion.store')}}" method="POST" id="enviar_linea_produccion" enctype="multipart/form-data">
                        {{csrf_field()}}

                        <div class="row">
                            <div class="col-sm-6 b-r">
                                <h4 class=""><b>Linea de Produccion</b></h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Registrar datos de la Linea Produccion:</p>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nombre_linea" name="nombre_linea" class="form-control {{ $errors->has('nombre_linea') ? ' is-invalid' : '' }}" value="{{old('nombre_linea')}}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="cantidad_personal" name="cantidad_personal" class="form-control {{ $errors->has('cantidad_personal') ? ' is-invalid' : '' }}" value="{{old('cantidad_personal')}}" >
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="nombre_imagen" name="nombre_imagen" class="form-control {{ $errors->has('nombre_imagen') ? ' is-invalid' : '' }}" value="{{old('nombre_imagen')}}" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="archivo_word" name="archivo_word" class="form-control {{ $errors->has('archivo_word') ? ' is-invalid' : '' }}" value="{{old('archivo_word')}}" >
...
$(document).ready(function() {
    ...
    $('.dataTables-linea_produccion-detalle').DataTable({
        ...
        //         titleAttr: 'Excel',
        //         title: 'Detalle de Linea de Produccion'
        //     },
        //     {
        //         titleAttr: 'Imprimir',
        //         extend: 'print',
...
$(document).on('click', '#editar_maquinaria_equipo', function(event) {
    ...
    $('#nombre_linea_editar').val(nombreMaquinariaEquipo(data[0]));
    $('#cantidad_personal_editar').val(data[2]);
...
function cargarMaquinariasEquipos() {
    ...
    //console.log(maquinaria_equipos);
...
function maquinaria_equipoPresentacion(maquinaria_equipo) {
    var presentacion = ""
    @foreach($maquinarias_equipos as $maquinaria_equipo)
    if ("{{$maquinaria_equipo->id}}" == maquinaria_equipo) {
        presentacion = "{{$maquinaria_equipo->presentacion}}"
    }
    @endforeach
    return presentacion
}
