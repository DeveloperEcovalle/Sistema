        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{route('produccion.orden.detalle.lote.store')}}" method="POST" id="enviar_orden_produccion_lote">
                        {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-xs-12">
                                        <input type="hidden" id="cantidadProduccion" name="cantidadProduccion" readonly class="form-control {{ $errors->has('cantidadProduccion') ? ' is-invalid' : '' }}" value="{{old('cantidadProduccion',$cantidadProduccion)}}" >
                                        <div class="form-group row">
                                                <div class="col-lg-6 col-xs-12">
                                                    <label class="">Cantidad de Producción</label>
                                                    <input type="text" id="cantidadProduccionCompleta" name="cantidadProduccionCompleta" readonly class="form-control {{ $errors->has('cantidadProduccionCompleta') ? ' is-invalid' : '' }}" value="{{old('cantidadProduccionCompleta',$cantidadProduccionCompleta)}}" >
                                                ...
                                                <div class="col-lg-6 col-xs-12" >
                                                    ...
                                                    <input type="number" id="cantidadExcedida" name="cantidadExcedida" class="form-control {{ $errors->has('cantidadExcedida') ? ' is-invalid' : '' }}" value="{{old('cantidadExcedida',$cantidadProduccion)}}" required>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-xs-12 b-r">
                                    <p>Seleccionar <b>Lote para la cantidad de Producción</b> :</p>
                                    <div class="row">
                                            <div class="col-lg-8 col-xs-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append"> 
                                                        <button type="button" class="btn btn-primary" onclick="buscarCantidadProduccion({{$articulo->id}},1)"><i class='fa fa-search'></i> Buscar
                                                        </button>
                                                    </span>
                                                </div>
                                ...
                                <div class="col-lg-6 col-xs-12 b-r">
                                    <p>Seleccionar <b>Lote para la cantidad Excedida </b>:</p>
                                    <div class="row">
                                            <div class="col-lg-8 col-xs-12">
                                                <label class="required">Lote Artículo:</label>
                                                <div class="input-group">
                                                    ...
                                                    <span class="input-group-append"> 
                                                        <button type="button" class="btn btn-primary" onclick="buscarCantidadProduccion({{$articulo->id}},2)"><i class='fa fa-search'></i> Buscar
                                                        </button>
                                                    </span>
                                                </div>
