        ...
        <div class="ibox ">
            ...
            <div class="ibox-content">
                ...
                <div class="table-responsive">
                    <table class="table dataTables-articulos table-striped table-bordered table-hover"  onkeyup="return mayus(this)">
                    <thead>
                        <tr>
    ...
    function eliminar(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //Ruta Eliminar
                var url_eliminar = '{{ route("produccion.subfamilia.destroy", ":id")}}';
