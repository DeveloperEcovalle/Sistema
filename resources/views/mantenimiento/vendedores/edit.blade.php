        ...
        <fieldset>
                    ...
                    <select id="tipo_documento" name="tipo_documento" class="select2_form form-control {{ $errors->has('tipo_documento') ? ' is-invalid' : '' }}">
                        ...
                        @foreach(tipos_documento() as $tipo_documento)
                            @if ($tipo_documento->simbolo != 'RUC')
                                <option value="{{ $tipo_documento->simbolo }}" {{ (old('tipo_documento', $vendedor->empleado->persona->tipo_documento) == $tipo_documento->simbolo ? "selected" : "") }} >{{ $tipo_documento->descripcion }}</option>
                            @endif
                        @endforeach
                    </select>
                </div>
            ...
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <input type="text" id="nombres" name="nombres" class="form-control {{ $errors->has('nombres') ? ' is-invalid' : '' }}" value="{{old('nombres', $vendedor->empleado->persona->nombres)}}" maxlength="100" onkeyup="return mayus(this)" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Apellido paterno</label>
                    <input type="text" id="apellido_paterno" name="apellido_paterno" class="form-control {{ $errors->has('apellido_paterno') ? ' is-invalid' : '' }}" value="{{old('apellido_paterno', $vendedor->empleado->persona->apellido_paterno)}}" onkeyup="return mayus(this)" maxlength="100" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Apellido materno</label>
                    <input type="text" id="apellido_materno" name="apellido_materno" class="form-control {{ $errors->has('apellido_materno') ? ' is-invalid' : '' }}" value="{{old('apellido_materno', $vendedor->empleado->persona->apellido_materno)}}" onkeyup="return mayus(this)" maxlength="100" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_nacimiento">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control {{ $errors->has('fecha_nacimiento') ? ' is-invalid' : '' }}" value="{{old('fecha_nacimiento', getFechaFormato($vendedor->empleado->persona->fecha_nacimiento, 'd/m/Y'))}}" readonly required >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xs-6">
                            <div class="radio">
                                <input type="radio" name="sexo" id="sexo_hombre" value="H" {{ ($vendedor->empleado->persona->sexo == 'H') ? "checked" : "" }}>
                        ...
                        <div class="col-sm-6 col-xs-6">
                            <div class="radio">
                                <input type="radio" name="sexo" id="sexo_mujer" value="M" {{ ($vendedor->empleado->persona->sexo == 'M') ? "checked" : "" }}>
                ...
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="estado_civil" name="estado_civil" class="select2_form form-control {{ $errors->has('estado_civil') ? ' is-invalid' : '' }}">
                        ...
                        @foreach(estados_civiles() as $estado_civil)
                            <option value="{{ $estado_civil->simbolo }}" {{ (old('estado_civil', $vendedor->empleado->persona->estado_civil) == $estado_civil->simbolo ? "selected" : "") }}>{{ $estado_civil->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
        ...
        <fieldset>
                ...
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="departamento" name="departamento" class="select2_form form-control {{ $errors->has('departamento') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(departamentos() as $departamento)
                            <option value="{{ $departamento->id }}" {{ (old('departamento', $vendedor->empleado->persona->departamento_id) == $departamento->id ? "selected" : "") }} >{{ $departamento->nombre }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="provincia" name="provincia" class="select2_form form-control {{ $errors->has('provincia') ? ' is-invalid' : '' }}" style="width: 100%">
                        <option></option>
                        @foreach(getProvinciasByDepartamento($vendedor->empleado->persona->departamento_id) as $provincia)
                            <option value="{{ $provincia->id }}" {{ (old('provincia', $vendedor->empleado->persona->provincia_id) == $provincia->id ? "selected" : "") }} >{{ $provincia->nombre }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="distrito" name="distrito" class="select2_form form-control {{ $errors->has('distrito') ? ' is-invalid' : '' }}" style="width: 100%">
                        <option></option>
                        @foreach(getDistritosByProvincia($vendedor->empleado->persona->provincia_id) as $distrito)
                            <option value="{{ $distrito->id }}" {{ (old('distrito', $vendedor->empleado->persona->distrito_id) == $distrito->id ? "selected" : "") }} >{{ $distrito->nombre }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-12 col-xs-12">
                    ...
                    <input type="text" id="direccion" name="direccion" class="form-control {{ $errors->has('direccion') ? ' is-invalid' : '' }}" value="{{old('direccion', $vendedor->empleado->persona->direccion)}}" maxlength="191" onkeyup="return mayus(this)" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Correo electrónico</label>
                    <input type="correo_electronico" id="correo_electronico" name="correo_electronico" class="form-control {{ $errors->has('correo_electronico') ? ' is-invalid' : '' }}" value="{{old('correo_electronico', $vendedor->empleado->persona->correo_electronico)}}" maxlength="100" onkeyup="return mayus(this)" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Teléfono móvil</label>
                    <input type="text" id="telefono_movil" name="telefono_movil" class="form-control {{ $errors->has('telefono_movil') ? ' is-invalid' : '' }}" value="{{old('telefono_movil', $vendedor->empleado->persona->telefono_movil)}}" onkeypress="return isNumber(event)" maxlength="9" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label>Teléfono fijo</label>
                    <input type="text" id="telefono_fijo" name="telefono_fijo" class="form-control {{ $errors->has('telefono_fijo') ? ' is-invalid' : '' }}" value="{{old('telefono_fijo', $vendedor->empleado->persona->telefono_fijo)}}" onkeypress="return isNumber(event)" maxlength="10">
                </div>
            </div>
            <div class="row">
                <div class="m-t-md col-lg-8">
        ...
        <fieldset style="position: relative;">
                ...
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="area" name="area" class="select2_form form-control {{ $errors->has('area') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(areas() as $area)
                            <option value="{{ $area->simbolo }}" {{ (old('area', $vendedor->empleado->area) == $area->simbolo ? "selected" : "") }} >{{ $area->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="profesion" name="profesion" class="select2_form form-control {{ $errors->has('profesion') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(profesiones() as $profesion)
                            <option value="{{ $profesion->simbolo }}" {{ (old('profesion', $vendedor->empleado->profesion) == $profesion->simbolo ? "selected" : "") }} >{{ $profesion->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="cargo" name="cargo" class="select2_form form-control {{ $errors->has('cargo') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(cargos() as $cargo)
                            <option value="{{ $cargo->simbolo }}" {{ (old('cargo', $vendedor->empleado->cargo) == $cargo->simbolo ? "selected" : "") }} >{{ $cargo->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <input type="text" id="sueldo" name="sueldo" class="form-control {{ $errors->has('sueldo') ? ' is-invalid' : '' }}" value="{{old('sueldo', $vendedor->empleado->sueldo)}}" maxlength="15" onkeypress="return filterFloat(event,this);" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Sueldo bruto</label>
                    <input type="text" id="sueldo_bruto" name="sueldo_bruto" class="form-control {{ $errors->has('sueldo_bruto') ? ' is-invalid' : '' }}" value="{{old('sueldo_bruto', $vendedor->empleado->sueldo_bruto)}}" onkeypress="return filterFloat(event,this);" maxlength="15" required>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label class="required">Sueldo neto</label>
                    <input type="text" id="sueldo_neto" name="sueldo_neto" class="form-control {{ $errors->has('sueldo_neto') ? ' is-invalid' : '' }}" value="{{old('sueldo_neto', $vendedor->empleado->sueldo_neto)}}" onkeypress="return filterFloat(event,this);" maxlength="15" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="moneda_sueldo" name="moneda_sueldo" class="select2_form form-control {{ $errors->has('moneda_sueldo') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(tipos_moneda() as $moneda)
                            <option value="{{ $moneda->simbolo }}" {{ (old('moneda_sueldo', $vendedor->empleado->moneda_sueldo) == $moneda->simbolo ? "selected" : "") }}>{{ $moneda->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <select id="tipo_banco" name="tipo_banco" class="select2_form form-control {{ $errors->has('tipo_banco') ? ' is-invalid' : '' }}" style="width: 100%">
                        ...
                        @foreach(bancos() as $banco)
                            <option value="{{ $banco->simbolo }}" {{ (old('tipo_banco', $vendedor->empleado->tipo_banco) == $banco->simbolo ? "selected" : "") }} >{{ $banco->descripcion }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
                    <label>Número de cuenta</label>
                    <input type="text" id="numero_cuenta" name="numero_cuenta" class="form-control {{ $errors->has('numero_cuenta') ? ' is-invalid' : '' }}" value="{{old('numero_cuenta', $vendedor->empleado->numero_cuenta)}}" maxlength="20" onkeypress="return isNumber(event)" onkeyup="return mayus(this)">
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12">
            ...
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_inicio_actividad" name="fecha_inicio_actividad" class="form-control {{ $errors->has('fecha_inicio_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_actividad', getFechaFormato($vendedor->empleado->fecha_inicio_actividad, 'd/m/Y'))}}" readonly required >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_fin_actividad" name="fecha_fin_actividad" class="form-control {{ $errors->has('fecha_fin_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_actividad', (!empty($vendedor->empleado->fecha_fin_actividad)) ? getFechaFormato($vendedor->empleado->fecha_fin_actividad, 'd/m/Y') : "")}}" readonly >
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_inicio_planilla" name="fecha_inicio_planilla" class="form-control {{ $errors->has('fecha_inicio_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_planilla', (!empty($vendedor->empleado->fecha_inicio_planilla)) ? getFechaFormato($vendedor->empleado->fecha_inicio_planilla, 'd/m/Y') : "")}}" readonly >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_fin_planilla" name="fecha_fin_planilla" class="form-control {{ $errors->has('fecha_fin_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_planilla', (!empty($vendedor->empleado->fecha_fin_planilla)) ? getFechaFormato($vendedor->empleado->fecha_fin_planilla, 'd/m/Y') : "")}}" readonly >
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-8 col-xs-12">
                    <div class="row">
                        <div class="form-group col-lg-6 col-xs-12">
                            ...
                            <input type="text" id="telefono_referencia" name="telefono_referencia" class="form-control {{ $errors->has('telefono_referencia') ? ' is-invalid' : '' }}" value="{{old('telefono_referencia', $vendedor->empleado->telefono_referencia)}}" maxlength="50" onkeyup="return mayus(this)">
                        </div>
                        <div class="form-group col-lg-6 col-xs-12">
                            <label>Contacto de referencia</label>
                            <input type="text" id="contacto_referencia" name="contacto_referencia" class="form-control {{ $errors->has('contacto_referencia') ? ' is-invalid' : '' }}" value="{{old('contacto_referencia', $vendedor->empleado->contacto_referencia)}}" maxlength="191" onkeyup="return mayus(this)">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-6 col-xs-12">
                            <label>Número de hijos</label>
                            <input type="text" id="numero_hijos" name="numero_hijos" class="form-control {{ $errors->has('numero_hijos') ? ' is-invalid' : '' }}" value="{{old('numero_hijos', $vendedor->empleado->numero_hijos)}}" onkeypress="return isNumber(event)" maxlength="2" >
                        </div>
                        <div class="form-group col-lg-6 col-xs-12">
                            ...
                            <select id="grupo_sanguineo" name="grupo_sanguineo" class="select2_form form-control {{ $errors->has('grupo_sanguineo') ? ' is-invalid' : '' }}" style="width: 100%">
                                ...
                                @foreach(grupos_sanguineos() as $grupo_sanguineo)
                                    <option value="{{ $grupo_sanguineo->simbolo }}" {{ (old('grupo_sanguineo', $vendedor->empleado->grupo_sanguineo) == $grupo_sanguineo->simbolo ? "selected" : "") }} >{{ $grupo_sanguineo->descripcion }} ({{ $grupo_sanguineo->simbolo }})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-12 col-xs-12">
                            ...
                            <textarea type="text" id="alergias" name="alergias" class="form-control {{ $errors->has('alergias') ? ' is-invalid' : '' }}" value="{{old('alergias', $vendedor->empleado->alergias)}}" rows="3" onkeyup="return mayus(this)"></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                <div class="custom-file">
                                    <input id="imagen" type="file" name="imagen" class="custom-file-input {{ $errors->has('imagen') ? ' is-invalid' : '' }}"  accept="image/*" src="{{ Storage::url($vendedor->empleado->ruta_imagen)}}">
                                    <label for="imagen" id="ruta_imagen" class="custom-file-label selected {{ $errors->has('ruta_imagen') ? ' is-invalid' : '' }}">
                                        @if($vendedor->empleado->nombre_imagen) {{$vendedor->empleado->nombre_imagen}} @else Seleccionar @endif
                                    </label>
                                ...
                                <div class="row justify-content-center">
                                    <p>
                                        @if($vendedor->empleado->ruta_imagen)
                                            <img class="logo" src="{{Storage::url($vendedor->empleado->ruta_imagen)}}" alt="">
                                            <input id="url_logo" name="url_logo" type="hidden" value="{{$vendedor->empleado->ruta_imagen}}">
                                        @else
