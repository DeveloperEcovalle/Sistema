        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                     ...
                     <form action="{{route('mantenimiento.empresas.update', $empresa->id)}}" method="POST" enctype="multipart/form-data" id="enviar_empresa_editar">
                        
                        {{ csrf_field() }} {{method_field('PUT')}}
              
                        <div class="row">
                            <div class="col-sm-6 b-r"><h4 class=""><b>Empresa</b></h4>
                                    <div class="row">
                                        <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control {{ $errors->has('ruc') ? ' is-invalid' : '' }}" name="ruc" id="ruc"  maxlength="11" value="{{old('ruc', $empresa->ruc)}}" >
                                        ...
                                        <div class="col-md-6">
                                                <label >Estado: </label>
                                                    ...
                                                    <input type="text" id="estado" class="form-control {{ $errors->has('estado') ? ' is-invalid' : '' }}" name="estado" value="{{ $empresa->activo == 1 ? 'ACTIVO' : 'INACTIVO'}}" style="text-transform:uppercase;" disabled>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('razon_social') ? ' is-invalid' : '' }}" name="razon_social" value="{{ old('razon_social', $empresa->razon_social)}}" id="razon_social" style="text-transform:uppercase;">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" id="razon_social_abreviada" class="form-control {{ $errors->has('razon_social_abreviada') ? ' is-invalid' : '' }}" name="razon_social_abreviada" value="{{ old('razon_social_abreviada',$empresa->razon_social_abreviada)}}" style="text-transform:uppercase;">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" id="direccion_fiscal" name="direccion_fiscal" class="form-control {{ $errors->has('direccion_fiscal') ? ' is-invalid' : '' }}" value="{{old('direccion_fiscal',$empresa->direccion_fiscal)}}" style="text-transform:uppercase;">{{old('direccion_fiscal',$empresa->direccion_fiscal)}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" id="direccion_llegada" name="direccion_llegada" class="form-control {{ $errors->has('direccion_llegada') ? ' is-invalid' : '' }}" value="{{old('direccion_llegada', $empresa->direccion_llegada)}}" style="text-transform:uppercase;">{{old('direccion_llegada',$empresa->direccion_llegada)}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" placeholder="" class="form-control" name="telefono" id="telefono" style="text-transform:uppercase;" value="{{old('telefono', $empresa->telefono)}}">
                                        </div>
                                        <div class="col-md-6">
                                            <label>Celular:</label> 
                                            <input type="text" placeholder="" class="form-control" name="celular" id="celular" style="text-transform:uppercase;" value="{{old('celular',$empresa->celular)}}">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="custom-file">
                                                <input id="logo" type="file" name="logo" id="logo" class="custom-file-input {{ $errors->has('logo') ? ' is-invalid' : '' }}" accept="image/*" src="{{ Storage::url($empresa->ruta_logo)}}" >
                                                
                                                
                                                <label for="logo" id="logo_txt" class="custom-file-label selected {{ $errors->has('ruta') ? ' is-invalid' : '' }}">
                                                @if($empresa->nombre_logo) {{$empresa->nombre_logo}} @else Seleccionar @endif</label>
                            ...
                            <div class="col-sm-6 b-r">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="dni_representante" class="form-control {{ $errors->has('dni_representante') ? ' is-invalid' : '' }}" id="dni_representante" value="{{old('dni_representante', $empresa->dni_representante)}}" maxlength="8" style="text-transform:uppercase;">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('nombre_representante') ? ' is-invalid' : '' }}" name="nombre_representante" id="nombre_representante" style="text-transform:uppercase;" value="{{old('nombre_representante',$empresa->nombre_representante)}}">
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('num_asiento') ? ' is-invalid' : '' }}" name="num_asiento" id="num_asiento" style="text-transform:uppercase;" value="{{old('num_asiento', $empresa->num_asiento)}}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('num_partida') ? ' is-invalid' : '' }}" name="num_partida" id="num_partida" style="text-transform:uppercase;" value="{{old('num_partida', $empresa->num_partida)}}" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 text-left" style="color:#fcbc6c">
                         ...
                         <div class="col-md-6 text-right">
                            <a  href="{{route('mantenimiento.empresas.index')}}"  id="btn_cancelar" class="btn btn-w-m btn-default">
