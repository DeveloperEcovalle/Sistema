        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                     ...
                     <form action="{{route('mantenimiento.empresas.store')}}" method="POST" enctype="multipart/form-data" id="enviar_empresa">
                        {{csrf_field()}}
                            ...
                            <div class="col-sm-6 b-r"><h4 class=""><b>Empresa</b></h4>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" id="direccion_fiscal" name="direccion_fiscal" required class="form-control {{ $errors->has('direccion_fiscal') ? ' is-invalid' : '' }}" value="{{old('direccion_fiscal')}}" style="text-transform:uppercase;">{{old('direccion_fiscal')}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" id="direccion_llegada" name="direccion_llegada" class="form-control {{ $errors->has('direccion_llegada') ? ' is-invalid' : '' }}" value="{{old('direccion_llegada')}}" style="text-transform:uppercase;" required >{{old('direccion_llegada')}}</textarea>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" placeholder="" class="form-control {{ $errors->has('telefono') ? ' is-invalid' : '' }}" name="telefono" id="telefono" style="text-transform:uppercase;" value="{{old('telefono')}}">
                                        ...
                                        <div class="col-md-6">
                                            <label>Celular:</label> 
                                            <input type="text" placeholder="" class="form-control {{ $errors->has('celular') ? ' is-invalid' : '' }}" name="celular" id="celular" style="text-transform:uppercase;" value="{{old('celular')}}">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="custom-file">
                                                <input id="logo" type="file" name="logo" id="logo" class="custom-file-input {{ $errors->has('logo') ? ' is-invalid' : '' }}"  accept="image/*">
                                                
                                                <label for="logo" id="logo_txt" class="custom-file-label selected {{ $errors->has('ruta') ? ' is-invalid' : '' }}">Seleccionar</label>
                            ...
                            <div class="col-sm-6 b-r">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="dni_representante" class="form-control {{ $errors->has('dni_representante') ? ' is-invalid' : '' }}" id="dni_representante" value="{{old('dni_representante')}}" maxlength="8" style="text-transform:uppercase;" onchange="evaluarDni(this.value)" required>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('nombre_representante') ? ' is-invalid' : '' }}" name="nombre_representante" id="nombre_representante" style="text-transform:uppercase;" value="{{old('nombre_representante')}}" required>
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('num_asiento') ? ' is-invalid' : '' }}" name="num_asiento" id="num_asiento" style="text-transform:uppercase;" value="{{old('num_asiento')}}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('num_partida') ? ' is-invalid' : '' }}" name="num_partida" id="num_partida" style="text-transform:uppercase;" value="{{old('num_partida')}}" required>
