...
<div class="wrapper wrapper-content animated fadeIn">
    <form class="wizard-big" action="{{ route('mantenimiento.empleado.update', $empleado->id) }}" method="POST" enctype="multipart/form-data" id="form_registrar_empleado">
        @csrf @method('PUT')
                ...
                <div class="col-lg-8 col-xs-12">
                    ...
                    <div class="row">
                        <div class="form-group col-lg-12 col-xs-12">
                            ...
                            <textarea type="text" id="alergias" name="alergias" class="form-control {{ $errors->has('alergias') ? ' is-invalid' : '' }}" value="{{old('alergias', $empleado->alergias)}}" rows="3" onkeyup="return mayus(this)"></textarea>
                        </div>
                    </div>
                </div>
