...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
        <h2 style="text-transform:uppercase;"><b>Modificar Empleado</b></h2>
        <ol class="breadcrumb">
...
<div class="wrapper wrapper-content animated fadeIn">
    <form class="wizard-big" action="{{ route('mantenimiento.empleado.update', $empleado->id) }}" method="POST" id="form_registrar_empleado">
        @csrf @method('PUT')
        ...
        <fieldset>
            <div class="row">
                ...
                <div class="form-group col-lg-4 col-xs-12">
                    ...
                    <input type="text" id="documento" name="documento" class="form-control {{ $errors->has('documento') ? ' is-invalid' : '' }}" value="{{old('documento', $empleado->persona->documento)}}" maxlength="8" onkeypress="return isNumber(event)" required>
                </div>
            ...
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_nacimiento">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control {{ $errors->has('fecha_nacimiento') ? ' is-invalid' : '' }}" value="{{old('fecha_nacimiento', getFechaFormato($empleado->persona->fecha_nacimiento, 'd/m/Y'))}}" autocomplete="off" required >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12">
            ...
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_inicio_actividad" name="fecha_inicio_actividad" class="form-control {{ $errors->has('fecha_inicio_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_actividad', getFechaFormato($empleado->fecha_inicio_actividad, 'd/m/Y'))}}" autocomplete="off" >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_actividad">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_fin_actividad" name="fecha_fin_actividad" class="form-control {{ $errors->has('fecha_fin_actividad') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_actividad', (!empty($empleado->fecha_fin_actividad)) ? getFechaFormato($empleado->fecha_fin_actividad, 'd/m/Y') : "")}}" autocomplete="off" >
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-lg-4 col-xs-12" id="fecha_inicio_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_inicio_planilla" name="fecha_inicio_planilla" class="form-control {{ $errors->has('fecha_inicio_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_inicio_planilla', getFechaFormato($empleado->fecha_inicio_planilla, 'd/m/Y'))}}" autocomplete="off" >
                    </div>
                </div>
                <div class="form-group col-lg-4 col-xs-12" id="fecha_fin_planilla">
                    ...
                    <div class="input-group date">
                        ...
                        <input type="text" id="fecha_fin_planilla" name="fecha_fin_planilla" class="form-control {{ $errors->has('fecha_fin_planilla') ? ' is-invalid' : '' }}" value="{{old('fecha_fin_planilla', (!empty($empleado->fecha_fin_planilla)) ? getFechaFormato($empleado->fecha_fin_planilla, 'd/m/Y') : "")}}" autocomplete="off" >
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-8 col-xs-12">
                    ...
                    <input type="text" id="alergias" name="alergias" class="form-control {{ $errors->has('alergias') ? ' is-invalid' : '' }}" value="{{old('alergias', $empleado->alergias)}}" onkeyup="return mayus(this)">
                </div>
            </div>
            <div class="row">
                <div class="m-t-md col-lg-8">
