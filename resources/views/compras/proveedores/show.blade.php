                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        <a href="{{route('compras.proveedor.edit',$proveedor->id)}}" class="btn btn-warning btn-xs float-right"><i class='fa fa-edit'></i>Editar Proveedor</a>
                                        <h2 style="text-transform:uppercase;">{{$proveedor->descripcion}}</h2>
                                    </div>
                                    <p style="text-transform:uppercase;"><strong><i class="fa fa-caret-right"></i> Información general del proveedor:</strong></p>
                            ...
                            <p style="text-transform:uppercase;"><strong> <i class="fa fa-caret-right"></i> Información del contacto:</strong></p>
                            <div class="row" style="text-transform:uppercase;">
                            ...
                            <hr>
                            <p style="text-transform:uppercase;"><strong><i class="fa fa-caret-right"></i> Información del Transporte:</strong></p>
                            <div class="row" style="text-transform:uppercase;">
                            ...
                            <hr>
                            <p style="text-transform:uppercase;"><strong><i class="fa fa-caret-right"></i> Información del Almacen:</strong></p>
                            <div class="row" style="text-transform:uppercase;">
                    ...
                    <div class="row">
                                <div class="col-lg-12">
                                    <dl class="row mb-0">
                                        ...
                                        <div class="col-sm-8 text-sm-right"><dd class="mb-1">  {{ Carbon\Carbon::parse($proveedor->created_at)->format('d/m/y - G:i:s') }}</dd> </div>
                                    </dl>
                                    <dl class="row mb-0">
                                        <div class="col-sm-4 text-sm-left"><dt>ACTUALIZADO:</dt> </div>
                                        <div class="col-sm-8 text-sm-right"> <dd class="mb-1">  {{ Carbon\Carbon::parse($proveedor->updated_at)->format('d/m/y - G:i:s') }}</dd></div>
                                    </dl>
