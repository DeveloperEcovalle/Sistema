                            ...
                            <div class="col-sm-6 b-r"><h4 class=""><b>Proveedor</b></h4>
                                    ...
                                    <div class="form-group row">
                                                ...
                                                <div class="col">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                                ...
                                                                value="RUC" @if(old('tipo_documento') == "RUC") {{'checked'}}@endif>
                                                ...
                                                <div class="col">
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio"
                                                                ...
                                                                value="DNI" @if(old('tipo_documento') == "DNI") {{'checked'}}@endif>
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <select class="select2_form form-control {{ $errors->has('tipo_persona') ? ' is-invalid' : '' }}" style="text-transform: uppercase; width:100%" value="{{old('tipo_persona')}}" name="tipo_persona" id="tipo_persona" required>
                                                    <option></option>
                                                    @foreach ($tipos as $tipo)   
                                                        <option value="{{$tipo->descripcion}}" @if(old('tipo_persona') == $tipo->descripcion ) {{'selected'}} @endif >{{$tipo->descripcion}}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group row" >
                                        ...
                                        <div class="col-md-6" id="ruc_requerido">
                                                ...
                                                <input type="text" id="ruc" class="form-control {{ $errors->has('ruc') ? ' is-invalid' : '' }}" name="ruc" maxlength="11" value="{{old('ruc')}}"   style="text-transform:uppercase;">
                                        ...
                                        <div class="col-md-6" id="dni_requerido" style="display:none;">
                                                ...
                                                <input type="text" id="dni" class="form-control {{ $errors->has('dni') ? ' is-invalid' : '' }}" name="dni" value="{{ old('dni')}}" maxlength="8"  style="text-transform:uppercase;">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control {{ $errors->has('descripcion') ? ' is-invalid' : '' }}" name="descripcion" value="{{ old('descripcion')}}" id="descripcion" style="text-transform:uppercase;" required>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea type="text" id="direccion" name="direccion" class="form-control {{ $errors->has('direccion') ? ' is-invalid' : '' }}" value="{{old('direccion')}}" style="text-transform:uppercase;" required >{{old('direccion')}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Web:</label> 
                                        <input type="text" placeholder="" class="form-control {{ $errors->has('web') ? ' is-invalid' : '' }}" name="web" id="web" style="text-transform:uppercase;" value="{{old('web')}}">
                                        @if ($errors->has('web'))
                                            <span class="invalid-feedback" role="alert">
