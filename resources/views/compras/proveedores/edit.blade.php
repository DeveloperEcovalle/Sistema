                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="" class="form-control {{ $errors->has('contacto') ? ' is-invalid' : '' }}" name="contacto" id="contacto" style="text-transform:uppercase;" value="{{old('contacto',$proveedor->contacto)}}">
