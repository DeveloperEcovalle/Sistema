                ...
                <form role="form" id="">
                    ...
                    <div class="form-group row">
                        <div class="col-md-8">
                            ...
                            <select class="select2_form form-control" style="text-transform: uppercase; width:100%"
                                name="tipo_editar" id="tipo_editar">
                                <option></option>
                            ...
                            <div class="invalid-feedback"><b><span id="error-tipo_editar"></span></b></div>
                        </div>
...
$(".editarRegistro").click(function() {
    ...
    if ($('#tipo_editar').val() == '') {
        ...
        $("#tipo_editar").addClass("is-invalid");
        $('#error-tipo_editar').text('El campo Tipo de Pago es obligatorio.')
    }
...
function limpiar() {
    ...
    $('#tipo_editar').removeClass("is-invalid")
    $('#error-tipo_editar').text('')
