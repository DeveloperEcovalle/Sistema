                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select
                                                        ...
                                                        style="text-transform: uppercase; width:100%" name="tipo_compra" id="tipo_compra">
                                                        <option></option>
                                                        @foreach (tipos_pago_caja() as $pago)
                                                        <option value="{{$pago->descripcion}}">{{$pago->descripcion}}</option>
                                                        @endforeach
                                                    </select>
                                                    <div class="invalid-feedback"><b><span id="error-tipo_compra"></span></b></div>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select
                                                        ...
                                                        <option value="{{$caja->id}}" >{{$caja->empleado->persona->apellido_paterno.' '.$caja->empleado->persona->apellido_materno.' '.$caja->empleado->persona->nombres}}</option>
                                                        @endforeach
                                                    </select>
...
function limpiarErrores() {
    ...
    $('#tipo_compra').removeClass("is-invalid")
    $('#error-tipo_compra').text('')
...
$(".enviar_caja").click(function() {
    ...
    if ($('#tipo_compra').val() == '') {
        toastr.error('Seleccione el tipo de pago.', 'Error');
        enviar = true;
        $('#tipo_compra').addClass("is-invalid")
        $('#error-tipo_compra').text('El campo Tipo de Pago es obligatorio.')
    } 
...
$(document).on('click', '#editar_documento', function(event) {
    ...
    $('#tipo_editar').val((data[3]));
    $('#tipo_editar').val(data[3]).trigger('change');
    $('#monto_editar').val(data[4]);
...
function limpiarDetalle() {
    ...
    $('#tipo_compra').val($('#tipo_compra option:first-child').val()).trigger('change');
