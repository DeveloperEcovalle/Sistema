                                            ...
                                            <div id="tab-1" class="tab-pane active">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group row">
                                                            ...
                                                            <input type="hidden" name="id_entidad" id="id_entidad" value="{{old('id_entidad', $pago[0]->banco_proveedor_id)}}">

                                                            <input type="hidden" name="moneda_proveedor_pago" id="moneda_proveedor_pago" value="{{old('moneda_proveedor_pago')}}">
                                                            <div class="col-md-3">

                                                                <label class="col-form-label">Descripción</label>
                                                                <input type="text" id="descripcion" class="form-control"  value="{{old('descripcion' , $pago[0]->descripcion)}}" disabled>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="text" id="moneda" class="form-control" value="{{old('moneda' , $pago[0]->tipo_moneda)}}" disabled>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="text" id="cuenta" class="form-control" value="{{old('num_cuenta' , $pago[0]->num_cuenta)}}" disabled>
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <input type="text" id="cci" class="form-control"  value="{{old('cci' , $pago[0]->cci)}}" disabled>
                                            ...
                                            <div id="tab-2" class="tab-pane">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group row">
                                                            ...
                                                            <input type="hidden" name="id_entidad_empresa" id="id_entidad_empresa" value="{{old('id_entidad_empresa',  $pago[0]->banco_empresa_id )}}">
                                                            <input type="hidden" name="moneda_empresa_pago" id="moneda_empresa_pago" value="{{old('moneda_empresa_pago')}}">
                                                            <div class="col-md-3">

                                                                <label class="col-form-label">Descripción</label>
                                                                <input type="text" id="descripcion_empresa" class="form-control" name="descripcion_empresa" disabled value="{{old('descripcion_empresa' , $pago[0]->descripcion_empresa)}}" >
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <label class="col-form-label">Moneda</label>
                                                                <input type="text" id="moneda_empresa" class="form-control" name="moneda_empresa" disabled value="{{old('moneda_empresa' , $pago[0]->moneda_empresa)}}" >
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <label class="col-form-label">N° Cuenta</label>
                                                                <input type="text" id="cuenta_empresa" class="form-control" name="cuenta_empresa" disabled value="{{old('cuenta_empresa' , $pago[0]->cuenta_empresa)}}" >
                                                            ...
                                                            <div class="col-md-3">
                                                                ...
                                                                <label class="col-form-label">N° CCI</label>
                                                                <input type="text" id="cci_empresa" class="form-control" name="cci_empresa" disabled value="{{old('cci_empresa' , $pago[0]->cci_empresa)}}" >
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6 text-left b-r">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <label class="col-form-label">Descripción</label>
                                                                                <input type="text" id="descripcion_empresa_detalle" class="form-control" value="{{old('descripcion_empresa' , $pago[0]->descripcion_empresa)}}" disabled>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <label class="col-form-label">Moneda</label>
                                                                                <input type="text" id="moneda_empresa_detalle" class="form-control" value="{{old('moneda_empresa' , $pago[0]->moneda_empresa)}}" name="moneda_empresa" disabled>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <label class="col-form-label">N° Cuenta</label>
                                                                                <input type="text" id="cuenta_empresa_detalle" class="form-control" value="{{old('cuenta_empresa' , $pago[0]->cuenta_empresa)}}" disabled>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <label class="col-form-label">N° CCI</label>
                                                                                <input type="text" id="cci_empresa_detalle" value="{{old('cci_empresa' , $pago[0]->cci_empresa)}}" class="form-control" disabled>
                                                                        ...
                                                                        <table class="table table-bordered m-t">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center" style="width:40%"><span id="moneda_cuenta_origen">{{old('moneda_empresa' , $pago[0]->moneda_empresa)}}</span></td>
                                                                                </tr>
                                                                        ...
                                                                        <div class="row form-group" id="campo_tipo_cambio_dia"><label class="col-lg-7 col-form-label text-right"><b>TIPO DE CAMBIO DEL DIA (<span id="simbolo_orden">
                                                                        @foreach(tipos_moneda() as $moneda)
                                                                            @if ($moneda->descripcion == $orden->moneda) 
                                                                                {{$moneda->simbolo}}
                                                                            @endif
                                                                        @endforeach
                                                                        </span> - <span id="simbolo_proveedor_2">
                                                                        @foreach(tipos_moneda() as $moneda)
                                                                            @if ($moneda->descripcion == old('moneda' , $pago[0]->moneda_proveedor)) 
                                                                                {{$moneda->simbolo}}
                                                                            @endif
                                                                        @endforeach
                                                                        </span>):</b></label>

                                                                            <div class="col-lg-5"><input type="text" placeholder="0.00" class="form-control text-center" name="tc_dia" id="tc_dia" value="{{old('tc_dia',$pago[0]->tc_dia)}}"> 
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-md-6 text-left">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <label class="col-form-label">Descripción</label>
                                                                                <input type="text" id="descripcion_detalle" value="{{old('descripcion' , $pago[0]->descripcion)}}" class="form-control" disabled>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <label class="col-form-label">Moneda</label>
                                                                                <input type="text" id="moneda_detalle" value="{{old('moneda' , $pago[0]->tipo_moneda)}}" name="moneda_proveedor" class="form-control" disabled>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <label class="col-form-label">N° Cuenta</label>
                                                                                <input type="text" id="cuenta_detalle" class="form-control" value="{{old('num_cuenta' , $pago[0]->num_cuenta)}}"  disabled>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <label class="col-form-label">N° CCI</label>
                                                                                <input type="text" id="cci_detalle" class="form-control" value="{{old('cci' , $pago[0]->cci)}}" disabled>
                                                                        ...
                                                                        <table class="table table-bordered m-t">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td><b>CUENTA DE ORIGEN (EMPRESA)</b></td>
                                                                                    <td class="text-center"><span  id="moneda_cuenta_origen_empresa">{{old('moneda_empresa' , $pago[0]->moneda_empresa)}}</span></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td><b>CUENTA DE DESTINO (PROVEEDOR)</b></td>
                                                                                    <td class="text-center" style="width:40%"><span id="moneda_cuenta_destino">{{old('moneda' , $pago[0]->tipo_moneda)}}</span></td>
                                                                                </tr>
                                                                        ...
                                                                        <div class="row form-group" id="campo_tipo_cambio_banco"><label class="col-lg-7 col-form-label text-right"><b>TIPO DE CAMBIO DEL BANCO (<span id="simbolo_empresa">

                                                                        @foreach(tipos_moneda() as $moneda)
                                                                            @if ($moneda->descripcion == old('moneda_empresa' , $pago[0]->moneda_empresa)) 
                                                                                {{$moneda->simbolo}}
                                                                            @endif
                                                                        @endforeach
                                                                        </span> - <span id="simbolo_proveedor">
                                                                        @foreach(tipos_moneda() as $moneda)
                                                                            @if ($moneda->descripcion == old('moneda' , $pago[0]->moneda_proveedor)) 
                                                                                {{$moneda->simbolo}}
                                                                            @endif
                                                                        @endforeach
                                                                            ...
                                                                            <div class="col-lg-5"><input type="text" placeholder="0.00" class="form-control text-center" name="tc_empresa_proveedor" id="tc_empresa_proveedor" value="{{old('tc_empresa_proveedor',$pago[0]->tc_banco)}}"> 
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-6 b-r">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-6 col-xs-12" id="fecha_pago">
                                                                            ...
                                                                            <div class="input-group date">
                                                                                ...
                                                                                <input type="text" id="fecha_pago_campo" name="fecha_pago"
                                                                                    ...
                                                                                    value="{{ old('fecha_pago', Carbon\Carbon::parse($pago[0]->fecha_pago)->format('d/m/Y') ) }}"
                                                                        ...
                                                                        <div class="col-lg-6 col-xs-12" id="">
                                                                            ...
                                                                            <input type="text" id="tipo_cambio" name="tipo_cambio" class="form-control {{ $errors->has('tipo_cambio') ? ' is-invalid' : '' }}" value="{{old('tipo_cambio',$pago[0]->tc_banco)}}" disabled placeholder="0.00">                                                                            
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-lg-6 col-xs-12" id="">
                                                                                ...
                                                                                <input type="text" id="monto" name="monto" class="form-control {{ $errors->has('monto') ? ' is-invalid' : '' }}" value="{{old('monto',$pago[0]->monto)}}" required placeholder="0.00" disabled>
                                                                                @if ($errors->has('monto'))
                                                                                <span class="invalid-feedback" role="alert">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <label class="" id="">Tipo de Cambio :</label>
                                                                                    <input type="text" id="tipo_cambio_soles" name="tipo_cambio_soles" class="form-control {{ $errors->has('tipo_cambio_soles') ? ' is-invalid' : '' }}" value="{{old('tipo_cambio_soles',$pago[0]->tipo_cambio_soles)}}"  placeholder="0.00">
                                                                            </div>
...
$(document).ready(function() {
    ...
    $('.dataTables-bancos').on('click', 'tbody td' , function() {
        ...
        $('#suma_monto_restante').val("{{$monto_restante + $pago[0]->monto}}")
    ...
    if ($('#moneda_cuenta_origen_empresa').text() != $('#moneda_cuenta_destino').text()){
            if ($('#moneda_cuenta_origen_empresa').text() != "SOLES") {
                ...
                monto_restante = Number("{{$monto_restante}}") + Number(cambio)
            }else{
                cambio =  monto / tipo_cambio
                monto_restante = Number("{{$monto_restante}}") + Number(cambio)
            }
            ...
            tipo_cambio = 1;
            monto_restante = Number("{{$monto_restante}}") + Number("{{$pago[0]->monto}}")
        }
...
$(document).ready(function() {
    //CAMBIO DE MONEDA MONSTRAR U OCULTAR INPUT TIPO DE CAMBIO (EMPRESA - PROVEEDOR)
    if ($('#moneda_cuenta_origen_empresa').text() != $('#moneda_detalle').val() ) {
        $("#campo_tipo_cambio_banco").css("display", "")
    }else{
        $("#campo_tipo_cambio_banco").css("display", "none");
    }
    ...
    //CAMBIAR SIMBOLO DE MONTO
    $('#simbolo_monto_empresa').text(simboloMoneda("{{$pago[0]->moneda_empresa}}"))
    $('#tipo_cambio_destino').text(simboloMoneda("{{$pago[0]->moneda_proveedor}}"))
    $('#simbolo_equivalente').text(simboloMoneda("{{$pago[0]->moneda_proveedor}}"))

    //MONEDAS
    $('#moneda_proveedor_pago').val("{{$pago[0]->moneda_proveedor}}")
    $('#moneda_empresa_pago').val("{{$pago[0]->moneda_empresa}}")
...
$('#monto').keyup(function() {
    ...
    // if ($('#moneda_cuenta_destino').text() == 'SOLES') {
    ...
    if ("{{$orden->moneda}}" != $('#moneda_detalle').val() ) {
        ...
        if(cambio > Number(monto_restante) || cambio < min   ){
            ...
            if (error!=true) {
                ...
                $('#monto').val('');
                $('#cambio').val('');
                $('#monto_equivalente').text(($('#suma_monto_restante').val()))
...
function buscarBancoEmpresa() {
    
    var id = $('#id_entidad_empresa').val()
    var descripcion = $('#descripcion_empresa').val()
    var moneda = $('#moneda_empresa').val()
    var cuenta  =  $('#cuenta_empresa').val()
    var cci = $('#cci_empresa').val()
    ...
    t.rows().data().each(function(row,el, index) {
        if (row[0] == id && 
            ...
            $(".dataTables-bancos-empresa tr:eq(" + (el+1) + ")").addClass('selected');
        }
    });
