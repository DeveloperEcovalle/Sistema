...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-12">
       <h2  style="text-transform:uppercase"><b>REGISTRAR NUEVO PAGO DE LA ORDEN DE COMPRA #{{$orden->id}} de la empresa: {{$orden->empresa->razon_social}}</b></h2>
        <ol class="breadcrumb">
                                    ...
                                    <div class="tabs-container">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li title="Datos de Contacto"><a class="nav-link" data-toggle="tab"
                                                    href="#tab-2" id="contacto_link"> <i class="fa fa-user"></i> Empresa</a></li>
                                        ...
                                        <div class="tab-content">
                                            <div id="tab-1" class="tab-pane active">
                                                <div class="panel-body">
                                                    <p><b>Datos del Proveedor a pagar:</b></p>
                    ...
                    <form action="{{route('compras.pago.store')}}" id="enviar_pago" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-8 b-r">
                                    ...
                                    <div class="form-group">
                                        <div class="table-responsive">
                                            <table class="table dataTables-bancoss table-striped table-bordered table-hover"
                                            style="text-transform:uppercase" id="table-bancos">
                                                <thead>
                                                    <tr>
                                                        <th></th>
