...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2 col-md-2">
        <a class="btn btn-block btn-w-m btn-primary m-t-md" href="{{route('seguridad.roles.create')}}">
            ...
            <div class="ibox ">
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table dataTables-rolesx table-striped table-bordered table-hover"
        ...
        "columns": [
            ...
            { data: 'name',className: "text-center"},
            {
                ...
                render: function(data) {
                    ...
                    //Ruta Modificar
                    var url_editar = '{{ route("seguridad.roles.edit", ":id")}}';
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            //Ruta Eliminar
            var url_eliminar = '{{ route("seguridad.roles.destroy", ":id")}}';
