...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-12">
       <h2  style="text-transform:uppercase"><b>MODIFICAR ROLES</b></h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{route('seguridad.roles.update', $roles->id)}}" method="POST" id="enviar_roles">
                        ...
                        <div class="row">
                            <div class="col-sm-6 b-r">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Modificar datos de la Roles:</p>
                                    </div>
                                </div>
...
$(document).ready(function() {
    // DataTables
    $('.dataTables-rol-detalle').DataTable({
...
function obtenerTabla() {
    ...
    @foreach($detalles as $detalle)
        var permiso = obtenerPermiso("{{$detalle->permission_id}}")
        t.row.add([
            '',
            "{{$detalle->permission_id}}",
            permiso
        ]).draw(false);
    @endforeach
}
...
$(".enviar_permiso").click(function() {
    ...
    var enviar = false;
    if ($('#permiso_id').val() == '') {
        toastr.error('Seleccione permiso.', 'Error');
        enviar = true;
