...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-12">
       <h2  style="text-transform:uppercase"><b>REGISTRAR NUEVO PERMISO</b></h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('home')}}">Panel de Control</a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('seguridad.permissions.index')}}">Permisos</a>
            </li>
        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{route('seguridad.permissions.store')}}" method="POST" id="enviar_permissions">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-sm-6 b-r">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>Registrar datos de la Permissions :</p>
                                    </div>
                                </div>
