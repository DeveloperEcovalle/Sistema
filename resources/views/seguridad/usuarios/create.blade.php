                            ...
                            <div class="col-sm-6 b-r"><h4 class=""><b>Usuario</b></h4>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" id="usuario" class="form-control {{ $errors->has('usuario') ? ' is-invalid' : '' }}" name="usuario" value="{{ old('usuario')}}"  style="text-transform:uppercase;" required>
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="email" id="correo" class="form-control {{ $errors->has('correo') ? ' is-invalid' : '' }}" name="correo" value="{{ old('correo')}}"  style="text-transform:uppercase;" required>
