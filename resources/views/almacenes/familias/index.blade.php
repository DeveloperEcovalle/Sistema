...
@include('almacenes.familias.create')
@include('almacenes.familias.edit')
...
<script>
    ...
    function obtenerData($id) {
        ...
        data.each(function (value, index) {
            if (value.id == $id) {
                ...
                $('#familia_editar').val(value.familia);
            }
        });
    ...
    function limpiarError() {
        $('#familia_editar').removeClass( "is-invalid" )
        $('#error-familia').text('')
    }
    ...
    function guardarError() {
        $('#familia_guardar').removeClass( "is-invalid" )
        $('#error-familia-guardar').text('')
    }

    $('#modal_crear_familia').on('hidden.bs.modal', function(e) {
        guardarError()
        $('#familia_guardar').val('')
    ...
    function eliminar(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                //Ruta Eliminar
                var url_eliminar = '{{ route("almacenes.familias.destroy", ":id")}}';
