...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
       <h2  style="text-transform:uppercase"><b>Listado de Nota de Salidad de Articulos</b></h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('home')}}">Panel de Control</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Nota de Salidad de articulo</strong>
            </li>
        </ol>
    </div>
    <div class="col-lg-2 col-md-2">
        <a class="btn btn-block btn-w-m btn-primary m-t-md" href="{{route('almacenes.nota_salidad_articulo.create')}}">
...
$(document).ready(function() {
    ...
    $('.dataTables-ingreso_mercaderia').DataTable({
        ...
        "bAutoWidth": false,
        "processing": true,
        "ajax": "{{ route('almacenes.nota_salidad_articulo.data')}}",
        "columns": [
            ...
            { data: 'fecha',className: "text-center"},
            {
                ...
                render: function(data) {
                    ...
                    //Ruta Modificar
                    var url_editar = '{{ route("almacenes.nota_salidad_articulo.edit", ":id")}}';
...
function eliminar(id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            //Ruta Eliminar
            var url_eliminar = '{{ route("almacenes.nota_salidad_articulo.destroy", ":id")}}';
