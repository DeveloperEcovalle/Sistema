                ...
                <div class="form-group row">
                    <div class="col-lg-12 col-xs-12">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="articulo_lote" name="articulo_lote" readonly>
...
function actualizarTabla(i) {
    ...
    var detalle = {
        ...
        articulo_id:$( "#modal_editar_detalle #articulo" ).val(),
        articulo_lote:$('#modal_editar_detalle #articulo_lote').val()
                }
