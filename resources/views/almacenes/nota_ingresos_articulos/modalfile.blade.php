        ...
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Subir el Excel</h4>
                            <form action="{{route('almacenes.nota_ingreso_articulo.downloadexcel')}}" method="get" style="display: inline-block;">
...
<script>
    var url="{{route('almacenes.nota_ingreso_articulo.uploadnotaingreso')}}";
