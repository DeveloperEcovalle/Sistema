                            ...
                            <table class="table dataTables-cliente table-striped table-bordered table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="5" class="text-center">UBICACIONES</th>
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">C.Tiendas</th>
                        ...
                        render: function(data) {
                           ...
                           /* return "<div class='btn-group'>" +
                            ...
                            return "<div class='btn-group' style='text-transform:capitalize;'><button data-toggle='dropdown' class='btn btn-primary btn-sm  dropdown-toggle'><i class='fa fa-bars'></i></button><ul class='dropdown-menu'>" +
                                ...
                                "<li><a class='dropdown-item' href='" + url_tienda +
                                "' title='Modificar' ><b><i class='fa fa-shopping-cart'></i>Tiendas</a></b></li>" +
