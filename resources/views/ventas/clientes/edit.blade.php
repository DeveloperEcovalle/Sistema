        ...
        <div class="col-lg-12">
            <div class="ibox">
                <div class="ibox-content">
                    <form action="{{ route('ventas.cliente.update', $cliente->id) }}" method="POST" id="form_modificar_cliente">
                        @csrf @method('PUT')
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <select id="tipo_documento" name="tipo_documento" class="select2_form form-control {{ $errors->has('tipo_documento') ? ' is-invalid' : '' }}">
                                    ...
                                    @foreach(tipos_documento() as $tipo_documento)
                                        <option value="{{ $tipo_documento->simbolo }}" {{ (old('tipo_documento', $cliente->tipo_documento) == $tipo_documento->simbolo ? "selected" : "") }} >{{ $tipo_documento->simbolo }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <input type="text" id="documento" name="documento" class="form-control {{ $errors->has('documento') ? ' is-invalid' : '' }}" value="{{old('documento', $cliente->documento)}}" maxlength="8" onkeypress="return isNumber(event)" required>
                            ...
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <input type="text" id="activo" name="activo" class="form-control {{ $errors->has('activo') ? ' is-invalid' : '' }}" value="{{old('activo', ($cliente->activo == 1) ? 'ACTIVO' : 'INACTIVO')}}" maxlength="8" readonly>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6 col-xs-12">
                                ...
                                <input type="text" id="nombre" name="nombre" class="form-control {{ $errors->has('nombre') ? ' is-invalid' : '' }}" value="{{old('nombre', $cliente->nombre)}}" maxlength="191" onkeyup="return mayus(this)" required>
                            ...
                            <div class="form-group col-lg-6 col-xs-12">
                                ...
                                <input type="text" id="direccion" name="direccion" class="form-control {{ $errors->has('direccion') ? ' is-invalid' : '' }}" value="{{old('direccion', $cliente->direccion)}}" maxlength="191" onkeyup="return mayus(this)" required>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <select id="departamento" name="departamento" class="select2_form form-control {{ $errors->has('departamento') ? ' is-invalid' : '' }}" style="width: 100%">
                                    ...
                                    @foreach(departamentos() as $departamento)
                                        <option value="{{ $departamento->id }}" {{ (old('departamento', $cliente->departamento_id) == $departamento->id ? "selected" : "") }} >{{ $departamento->nombre }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <select id="provincia" name="provincia" class="select2_form form-control {{ $errors->has('provincia') ? ' is-invalid' : '' }}" style="width: 100%">
                                    <option></option>
                                    @foreach(getProvinciasByDepartamento($cliente->departamento_id) as $provincia)
                                        <option value="{{ $provincia->id }}" {{ (old('provincia', $cliente->provincia_id) == $provincia->id ? "selected" : "") }} >{{ $provincia->nombre }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <select id="distrito" name="distrito" class="select2_form form-control {{ $errors->has('distrito') ? ' is-invalid' : '' }}" style="width: 100%">
                                    <option></option>
                                    @foreach(getDistritosByProvincia($cliente->provincia_id) as $distrito)
                                        <option value="{{ $distrito->id }}" {{ (old('distrito', $cliente->distrito_id) == $distrito->id ? "selected" : "") }} >{{ $distrito->nombre }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <input type="text" id="telefono_movil" name="telefono_movil" class="form-control {{ $errors->has('telefono_movil') ? ' is-invalid' : '' }}" value="{{old('telefono_movil', $cliente->telefono_movil)}}" onkeypress="return isNumber(event)" maxlength="9" required>
                            ...
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <input type="text" id="telefono_fijo" name="telefono_fijo" class="form-control {{ $errors->has('telefono_fijo') ? ' is-invalid' : '' }}" value="{{old('telefono_fijo', $cliente->telefono_fijo)}}" onkeypress="return isNumber(event)" maxlength="10">
                            ...
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <input type="email" id="correo_electronico" name="correo_electronico" class="form-control {{ $errors->has('correo_electronico') ? ' is-invalid' : '' }}" value="{{old('correo_electronico', $cliente->correo_eletronico)}}" maxlength="100" onkeyup="return mayus(this)">
                        ...
                        <div id="section_datos_contacto">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-4 col-xs-12">
                                    ...
                                    <input type="text" id="nombre_contacto" name="nombre_contacto" class="form-control {{ $errors->has('nombre_contacto') ? ' is-invalid' : '' }}" value="{{old('nombre_contacto', $cliente->nombre_contacto)}}" maxlength="191" onkeyup="return mayus(this)">
                                ...
                                <div class="form-group col-lg-4 col-xs-12">
                                    ...
                                    <input type="text" id="telefono_contacto" name="telefono_contacto" class="form-control {{ $errors->has('telefono_contacto') ? ' is-invalid' : '' }}" value="{{old('telefono_contacto', $cliente->telefono_contacto)}}" onkeypress="return isNumber(event)" maxlength="9">
                                ...
                                <div class="form-group col-lg-4 col-xs-12">
                                    <label>Correo electrónico</label>
                                    <input type="email" id="correo_electronico_contacto" name="correo_electronico_contacto" class="form-control {{ $errors->has('correo_electronico_contacto') ? ' is-invalid' : '' }}" value="{{old('correo_electronico_contacto', $cliente->correo_electronico_contacto)}}" maxlength="100" onkeyup="return mayus(this)">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <select id="moneda_credito" name="moneda_credito" class="select2_form form-control {{ $errors->has('moneda_credito') ? ' is-invalid' : '' }}">
                                    ...
                                    @foreach(tipos_moneda() as $moneda)
                                        <option value="{{ $moneda->simbolo }}" {{ (old('moneda_credito', $cliente->moneda_credito) == $moneda->simbolo ? "selected" : "") }}>{{ $moneda->descripcion }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-lg-4 col-xs-12">
                                ...
                                <input type="text" id="limite_credito" name="limite_credito" class="form-control {{ $errors->has('limite_credito') ? ' is-invalid' : '' }}" value="{{old('limite_credito', $cliente->limite_credito)}}" onkeypress="return filterFloat(event,this);" maxlength="15">
