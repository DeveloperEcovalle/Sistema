...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
       <h2  style="text-transform:uppercase"><b>Listado de Pagos del documento de venta #{{$documento->id}} por el cliente "{{$documento->cliente}} " por medio de transferencia</b></h2>
       <ol class="breadcrumb">
