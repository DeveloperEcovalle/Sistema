...
<head>
    ...
    <title>419 | Sistema de Producción</title>
...
<body class="gray-bg">
    ...
    <div class="middle-box text-center animated fadeInDown">
        <h1>419</h1>
        <h3 class="font-bold">La sesión ha expirado.</h3>

        <div class="error-desc">
           
                Disculpe, su sesión ha expirado. Se recomienda refescar Página o Iniciar Sesión otra vez.
