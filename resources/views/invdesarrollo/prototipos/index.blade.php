...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-2 col-md-2">
        <a class="btn btn-block btn-w-m btn-primary m-t-md" href="{{route('invdesarrollo.prototipo.create')}}">
            ...
            <div class="ibox ">
                <div class="ibox-content">
                    <div class="table-responsive">
                        <table class="table dataTables-prototipo table-striped table-bordered table-hover"
...
$(document).ready(function() {
    ...
    // DataTables
    $('.dataTables-prototipo').DataTable({
        ...
        "columns": [
            ...
            { data: 'estado',className: "text-center"},
            {
                ...
                render: function(data) {
                    //Ruta Detalle
                    var url_detalle = '{{ route("invdesarrollo.prototipo.show", ":id")}}';
                    url_detalle = url_detalle.replace(':id', data.id);

                    //Ruta Modificar
                    var url_editar = '{{ route("invdesarrollo.prototipo.edit", ":id")}}';
