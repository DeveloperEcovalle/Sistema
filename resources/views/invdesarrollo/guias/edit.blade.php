...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-12">
       <h2  style="text-transform:uppercase"><b>MODIFICAR NUEVA GUIA INTERNA</b></h2>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    ...
                    <form action="{{route('invdesarrollo.guia.update', $guia->id)}}" method="POST" id="enviar_guia">
                         @csrf @method('PUT')
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" id="unidades_a_producir" name="unidades_a_producir" class="form-control {{ $errors->has('unidades_a_producir') ? ' is-invalid' : '' }}" value="{{old('unidades_a_producir',$guia->unidades_a_producir)}}" >
